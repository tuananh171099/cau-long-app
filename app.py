...
# CSS Tối ưu giao diện Mobile & Dàn lưới 2 trận / hàng
st.markdown(
    """
    <style>
    ...
    /* Thẻ trận đấu dạng Grid thu gọn */
    .match-item-card {
...
# ==========================================
# 3. LỊCH SỬ CÁC TRẬN ĐẤU (DÀN LƯỚI 2 CỘT / HÀNG NHƯ HÌNH BẠN VẼ)
# ==========================================
    ...
    if matches_df.empty:
        ...
        for match_date in grouped_dates:
            ...
            # Chuyển sang dạng Lưới 2 cột song song
